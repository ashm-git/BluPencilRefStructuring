...
namespace RefBOT.Controllers
{
    class Database
    {
        ...
        public void StyleLogIns(string InputStyle, string OutputStyle)
        {
            try
            {
                ...
                using (NpgsqlConnection connection = new NpgsqlConnection())
                {
                    ...
                    cmd.Parameters.Add(new NpgsqlParameter("@ID", General.customer + "\\" + General.GeneralInstance.projectName));
                    cmd.Parameters.Add(new NpgsqlParameter("@Input_Style", InputStyle));
                    cmd.Parameters.Add(new NpgsqlParameter("@Output_Style", OutputStyle));
        ...
        public void ReadFromDatabase1(NpgsqlCommand cmd, string query, NpgsqlConnection connection)
        {
            try
            {
                // using (NpgsqlConnection connection = new NpgsqlConnection())
        ...
        public void HistoryLogIns(string logType, string logDescription, string startTime)
        {
            try
            {
                ...
                using (NpgsqlConnection connection = new NpgsqlConnection())
                {
                    ...
                    cmd.CommandType = CommandType.Text;
                    cmd.Parameters.Add(new NpgsqlParameter("@username", General.GeneralInstance.currentUser));
                    cmd.Parameters.Add(new NpgsqlParameter("@logtype", logType));
                    cmd.Parameters.Add(new NpgsqlParameter("@dt1", startTime));
                    cmd.Parameters.Add(new NpgsqlParameter("@dt2", DateTime.UtcNow.ToString()));
                    cmd.Parameters.Add(new NpgsqlParameter("@doc_id", General.GeneralInstance.docId));
                    cmd.Parameters.Add(new NpgsqlParameter("@modulename", General.LogMethod));
                    cmd.Parameters.Add(new NpgsqlParameter("@description", logDescription));
                    cmd.ExecuteNonQuery();
                    cmd.Dispose();
                    connection.Close();
        ...
        private void InsertRecord(SqlConnection connection, string[] records)
        {
            try
            {
                ...
                //cmd.Parameters.Add(new NpgsqlParameter("@user", records[0]));
                cmd.Parameters.Add(new SqlParameter("@user", records[0]));
                //cmd.Parameters.Add(new NpgsqlParameter("@type", records[1]));
                cmd.Parameters.Add(new SqlParameter("@type", records[0]));
                //cmd.Parameters.Add(new NpgsqlParameter("@dt1", DateTime.ParseExact(records[2], "dd-MMM-yy h:mm:ss tt", System.Globalization.CultureInfo.InvariantCulture)));
                cmd.Parameters.Add(new NpgsqlParameter("@dt2", DateTime.ParseExact(records[3], CultureInfo.CurrentCulture.DateTimeFormat.ShortDatePattern + " " + CultureInfo.CurrentCulture.DateTimeFormat.LongTimePattern, System.Globalization.CultureInfo.InvariantCulture)));

                if (records[2] != "null")
                    cmd.Parameters.Add(new NpgsqlParameter("@dt1", DateTime.ParseExact(records[2], CultureInfo.CurrentCulture.DateTimeFormat.ShortDatePattern + " " + CultureInfo.CurrentCulture.DateTimeFormat.LongTimePattern, System.Globalization.CultureInfo.InvariantCulture)));

                cmd.Parameters.Add(new NpgsqlParameter("@doc_id", records[4]));
                cmd.Parameters.Add(new NpgsqlParameter("@module", records[5]));
                cmd.Parameters.Add(new NpgsqlParameter("@description", records[6]));
        ...
        public bool ExecuteNonQueryFunction(string sQuery)
        {
            try
            {
                ...
                connection.ConnectionString = GetConnectionString;
                connection.Open();
                NpgsqlCommand command = new NpgsqlCommand(sQuery, connection);
